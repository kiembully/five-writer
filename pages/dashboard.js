        ...
        <div className={dashboardStyles.dashboardWrap}>
            <div className={dashboardStyles.orderFilter}>
                ...
                <span className={dashboardStyles.spnSearchWrap}>
                    <span><MdSearch /></span>
                    <input type="text" placeholder="Search..." value={textFilter} onChange={handleTextFilter}></input>
                </span>
            </div>
            ...
            <Table sx={{ minWidth: 650 }} aria-label="orders table">
                ...
                <TableBody>
                  <TableRow>
                  <TableCell className={dashboardStyles.tblCell} colSpan={14}>
                    {apiLoader || orderCount > 0 ?
                    <>
                    ...
                    :
                    <h3 className={dashboardStyles.h3emptyList}>{orderMessage}</h3>
                    }
                  </TableCell>
                  </TableRow>
                </TableBody>
                ...
                <TableBody>
                {(rowsPerPage > 0
                    ? myOrders.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage)
                    : myOrders
                ).map((row, index) => (
                    <TableRow
                    key={index}
                ...
                <TableRow>
                    <TablePagination
                    className={dashboardStyles.tpOrders}
